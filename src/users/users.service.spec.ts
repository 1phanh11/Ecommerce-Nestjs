...
describe('UsersService', () => {
  ...
  describe('update profile', () => {
    it('Should throw not found exception', async () => {
      ...
      await expect(
        userService.updateProfile('user-1', { name: 'abc' }),
    ...
    it('Update success', async () => {
      ...
      await expect(
        userService.updateProfile('user-1', { name: 'alex' }),
  ...
  describe('Admin update user role', () => {
    it('Should throw not found exception if user not exist', async () => {
      ...
      await expect(
        userService.adminUpdate('user-1', { role: 'USER' }, 'admin-1'),
      ).rejects.toThrow(NotFoundException);
    });
    ...
    it('Should throw forbiden exception if admin try to update self role', async () => {
      ...
      await expect(
        userService.adminUpdate('admin-1', { role: 'USER' }, 'admin-1'),
